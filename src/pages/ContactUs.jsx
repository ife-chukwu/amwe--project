        ...
        <aside className="md:w-2/3 p-2 md:m-3 rounded-xl md:px-4 md:py-10 bg-red-500 text-gray-200 flex flex-col gap-5 h-full">
          ...
          <div className="flex gap-2 items-center">
            ...
            <div className="w-5/6 flex flex-col gap-1 ">
              <h1 className="font-bold text-lg underline"><a href="mailto:info@amwe.com.ng">Send us a mail</a></h1>
          ...
          <div className="flex gap-2 items-center">
            ...
            <div className="w-5/6 flex flex-col gap-1">
              <h1 className="font-bold text-lg underline"><a href="https://www.google.com/maps/dir/9.1026712,7.448954/efab+mall+garki+area+11+google+map/@8.9206714,7.6241384,8.19z/data=!4m9!4m8!1m1!4e1!1m5!1m1!1s0x104e0b660a57fc4b:0xf7d6e88e02143540!2m2!1d7.5037303!2d9.0436293">Office Address</a></h1>
              <p className="text-sm">Come say 'hello' at our office</p>
              <i className="font-bold text-sm"><a href="https://www.google.com/maps/dir/9.1026712,7.448954/efab+mall+garki+area+11+google+map/@8.9206714,7.6241384,8.19z/data=!4m9!4m8!1m1!4e1!1m5!1m1!1s0x104e0b660a57fc4b:0xf7d6e88e02143540!2m2!1d7.5037303!2d9.0436293">
                Exit E, 42 second floor, Efab Mall, block E extension, by the
                Coca-Cola deport, Area 11 Garki, Abuja, Nigeria.</a>
              </i>
            </div>
          </div>
          <div className="flex gap-2 items-center">
            ...
            <div className="w-5/6 flex flex-col gap-1">
              <h1 className="font-bold text-lg underline"><a href="tel:+2348063418882">Phone</a></h1>
          ...
          <div className="flex items-center gap-10 justify-center mb-5 mt-10 w-full text-gray-200 md:mt-32">
            <div>
              <a href="https://web.facebook.com/amweevent">
                <AiFillFacebook size={25} className="hover:translate-y-1 transition-all duration-500" />
              </a>
            </div>
            <div>
              <a href="https://youtu.be/RxXA6HZgI_g">
                <AiFillYoutube size={25} className="hover:translate-y-1 transition-all duration-500" />
              </a>
            </div>
            <div>
              <a href="#">
                <AiFillInstagram size={25} className="hover:translate-y-1 transition-all duration-500" />
              </a>
            </div>
            <div>
              <a href="#">
                <AiFillLinkedin size={25} className="hover:translate-y-1 transition-all duration-500" />
              </a>
            </div>
          </div>
        </aside>
        {!isFormSubmitted ? <aside className="md:w-3/4 p-2 md:pl-5 font-light mt-10 md:mt-0">
          <div className="">
