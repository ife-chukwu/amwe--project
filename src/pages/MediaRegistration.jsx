...
const MediaRegistration = () => {
  ...
  const [isFileGood, setIsFileGood] = useState(false);
        ...
        {!isFormCorrect && (
          <div className="md:px-10 p-5">
            ...
            <p className="mt-2 font-extralight text-center md:text-start">
              ...
              bloggers and influencers interested in covering AMWE 2023. Media
              will have access to all open-door plenaries, parallel sessions,
              press conferences and other media-focused events. They will also
              enjoy access to a media room from where they can file their
              reports live on location.
            </p>
          </div>
        )}
        {!isFormCorrect ? (
          <div className="w-full md:w-3/4 p-2">
            <p className="text-[#0F2F63]">Please indicate the required field</p>
            <form
            ...
            >
              <div className="flex flex-col gap-5 justify-between px-2">
                ...
                <label htmlFor="cardId" className="text-gray-200">
                  For accreditation purposes, please provide a copy of valid
                  press credentials issued by your media outlet or locally
                  recognized media association. Photographers and videographers
                  covering the conference must provide proof of affiliation to
                  registered production agencies or client news organisations.{" "}
                </label>
          ...
          <div className="flex flex-col gap-4 tracking-wider md:w-[60%] p-10 md:p-0">
            <h1 className="text-3xl text-[#0F2F63] font-bold">Thank You!</h1>
            <p className="font-bold">
              Many thanks for your interest in covering or participating in AMWE
              2023.
            </p>
